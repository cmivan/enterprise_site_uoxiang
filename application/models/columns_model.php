...
class Columns_Model extends CI_Model {
	...
	function get_types_num()
	{
    	...
    	return $this->db->count_all_results('columns_type');
	}
	...
	function hit($id=0)
	{
    	...
    	$this->db->where('id', $id);
    	return $this->db->update('columns_type');
	}
	...
	function del_type($type_id)
	{
    	...
    	return $this->db->delete('columns_type'); 
	}
