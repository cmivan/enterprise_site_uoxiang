...
class Download_Model extends CI_Model {
	...
	function get_types_num()
	{
    	...
    	return $this->db->count_all_results('download_type');
	}
	...
	function hit($id=0)
	{
    	...
    	$this->db->where('id', $id);
    	return $this->db->update('download_type');
	}
	...
	function del_type($type_id)
	{
    	...
    	return $this->db->delete('download_type'); 
	}
