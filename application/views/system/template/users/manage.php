...
<td>&nbsp;名称</td>
<td width="75" align="center">登录次数</td>
<td width="150" align="center">最后登录</td>
...
<td>&nbsp;<?php echo keycolor($item->username,$keyword);?></td>
<td align="center"><?php echo $item->hits;?></td>
<td align="center"><?php echo $item->logintime;?></td>
<td align="center"><?php echo $item->loginIp;?></td>
<td align="center"><?php echo cm_form_check('ok',$item->id,$item->ok);?></td>
<td align="center">
